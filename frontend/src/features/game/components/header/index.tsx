  ...
  return (
    <Card className="border-white/10 bg-white/5 py-0 shadow-2xl backdrop-blur">
      <CardHeader className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div
          style={{ opacity: countdownSeconds ? 1 : 0 }}
          className="transition-opacity duration-300 flex flex-col items-center justify-center rounded-xl border border-cyan-400/35 bg-cyan-500/10 px-6 py-3 sm:min-w-36"
        >
